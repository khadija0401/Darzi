...
<body>
		...
		<!--html part start-->
				...
				<div class="col-6 border border-success p-4 ml-2 " style="margin-top:200px;float:right; width:600px; margin-right:20px;">
					<div class="otp_msg"></div>
					<h1 class="text-danger text-center">OTP VERIFICATION</h1>
					<form method="POST"  action="test.php">
						<div class="form-group">
							<label for="mobile">Enter Mobile Number</label>
							<input type="text" class="form-control" id="mob" name="contact_no"  placeholder="Enter mobile"  required>
                        ...
                        <br>  <input type="submit" name="save" id="formsubmit" class="btn btn-primary" value="NEXT" >
			...
			$('#verifyotp').click(function(){
						...
						$.ajax({
							...
							success: function(data){
									...
									$('.otp_msg').html('<div class="alert alert-success">OTP Verified successfully <a href="Registeration.php"></div>').show().fadeOut(4000);
                                    $('#formsubmit').css("display","block");
                                    // alert("You will now be redirected.");
                                    // window.location = "profile.php?tailor_id=<?php echo "1" ?>";
